...
const logger = createLogger('admin/pinterest-campaigns')
...
export default function AdminPinterestCampaignsPage() {
  ...
  const handleFetchBoards = async () => {
    await handleAction('fetch_boards', { sessionId: newCampaign.sessionId })
