      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex gap-6">
          ...
          <main className="flex-1 max-w-3xl">
            {/* Page Title */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Videos</h1>
              <p className="text-gray-600 dark:text-gray-400">Watch videos from YapGrid communities</p>
            </div>
              ...
              <>
                ...
                <div ref={loadMoreSentinelRef} className="h-20 flex items-center justify-center">
                  ...
                  {!hasMore && posts.length > 0 && (
                    <p className="text-gray-500 dark:text-gray-400">No more videos to load</p>
                  )}
                </div>

                {posts.length === 0 && !loading && (
                  <div className="text-center py-12">
                    <p className="text-gray-500 dark:text-gray-400">No video posts found</p>
                  </div>
                )}
              </>
            )}
