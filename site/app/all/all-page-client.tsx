  ...
  const fetchPosts = useCallback(async (pageNum: number) => {
    try {
      ...
      const params = new URLSearchParams({
        ...
        pageSize: '15',
        status: 'PUBLISHED',
        includeNsfw: 'true' // All posts = includes NSFW
      })
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex gap-6">
          ...
          <main className="flex-1 max-w-3xl">
            {/* Page Title */}
            <div className="mb-6">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">All Posts</h1>
              <p className="text-gray-600 dark:text-gray-400">All posts from YapGrid communities</p>
            </div>
